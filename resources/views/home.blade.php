    ...
    <div class="card-body">
      <table class="table table-striped table-hover">
        ...
        <tbody id="data-jadwal">
          ...
          @if ( $jadwal->count() > 0 )
          @if (
          $hari == '1' && $jam >= '09:30' && $jam <= '10:00' || $hari=='1' && $jam>= '12:00' && $jam <= '13:00' ||
              $hari=='2' && $jam>= '09:30' && $jam <= '10:00' || $hari=='2' && $jam>= '12:00' && $jam <= '13:00' ||
                  $hari=='3' && $jam>= '09:30' && $jam <= '10:00' || $hari=='3' && $jam>= '12:00' && $jam <= '13:00' ||
                      $hari=='4' && $jam>= '09:00' && $jam <= '09:30' || $hari=='4' && $jam>= '12:00' && $jam <= '13:00'
                          ) <tr>
                          <td colspan='5' style='background:#fff;text-align:center;font-weight:bold;font-size:18px;'>
                            Waktunya Istirahat!</td>
                          </tr>
                          @else
                          ...
                          <tr>
                            ...
                            <td>R uangan {{ $data->ruang->nama_ruang }} </td>
                            <td>
                          ...
                          @elseif ($jam <= '06:00' ) <tr>
                            ...
                            @elseif($hari == '1' && $jam >= '07:00' && $jam <= '07:29' ) <tr>
                              <td colspan='5'
        ...
        setInterval(function() {
          ...
          if (hari == '0' || hari == '6') {
            ...
            if (jam <= '06:00') {
              ...
              } else if (hari == '1' && jam >= '07:00' && jam <= '07:29') {
                $("#data-jadwal").html(
                  `<tr>
