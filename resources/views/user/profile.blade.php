                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            ...
                            <select id="mapel_id" name="mapel_id"
                                ...
                                <option value="{{ $data->id }}" @if (Auth::user()->guru(Auth::user()->id_card)->mapel_id
                                    == $data->id)
                                    selected
                                    @endif
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            ...
                            <select id="jk" name="jk" class="select2bs4 form-control @error('jk') is-invalid @enderror">
                                ...
                                <option value="L" @if (Auth::user()->guru(Auth::user()->id_card)->jk == 'L')
                                    selected
                                    @endif
                                    >Laki-Laki</option>
                                <option value="P" @if (Auth::user()->guru(Auth::user()->id_card)->jk == 'P')
                                    selected
                                    @endif
                                    >Perempuan</option>
                            </select>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" id="no_induk" name="no_induk"
                                value="{{ Auth::user()->siswa(Auth::user()->no_induk)->no_induk }}" class="form-control"
                                disabled>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <select id="jk" name="jk" class="select2bs4 form-control @error('jk') is-invalid @enderror">
                                <option value="">-- Pilih Jenis Kelamin --</option>
                                <option value="L" @if (Auth::user()->siswa(Auth::user()->no_induk)->jk == 'L')
                                    selected
                                    @endif
                                    >Laki-Laki</option>
                                <option value="P" @if (Auth::user()->siswa(Auth::user()->no_induk)->jk == 'P')
                                    selected
                                    @endif
                                    >Perempuan</option>
                            </select>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            ...
                            <select id="kelas_id" name="kelas_id"
                                ...
                                <option value="{{ $data->id }}" @if (Auth::user()->
                                    siswa(Auth::user()->no_induk)->kelas_id == $data->id)
                                    selected
                                    @endif
