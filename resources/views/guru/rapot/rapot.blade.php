                    ...
                    <table class="table table-bordered table-striped table-hover">
                        <thead>
                            <tr style="background:#007bff ">
                                <th class="ctr" rowspan="2" style="color: white">No.</th>
                                <th rowspan="2" style="color: white">Nama Siswa</th>
                                <th class="ctr" colspan="3" style="color: white">Pengetahuan</th>
                                <th class="ctr" colspan="3" style="color: white">Keterampilan</th>
                                <th class="ctr" rowspan="2" style="color: white">Aksi</th>
                            </tr>
                            <tr style="background:#007bff ">
                        ...
                        <tbody>
                            <form action="" method="post" id="formRapot">
                                ...
                                <tr>
                                    ...
                                    <td class="ctr">
                                        <textarea class="form-control swal2-textarea textarea-rapot" cols="50" rows="5"
                                            disabled>{{ $data->nilai($data->id)->p_deskripsi }}</textarea>
                                    </td>
                                    @if ($data->nilai($data->id)->p_nilai && $data->nilai($data->id)->k_nilai)
                                    <td class="ctr">
                                        <div class="ka_{{$data->id}} text-center">{{ $data->nilai($data->id)->k_nilai }}
                                        </div>
                                    </td>
                                    <td class="ctr">
                                        <div class="kp_{{$data->id}} text-center">
                                            {{ $data->nilai($data->id)->k_predikat }}</div>
                                    </td>
                                    <td class="ctr">
                                        <textarea class="form-control swal2-textarea textarea-rapot" cols="50" rows="5"
                                            disabled>{{ $data->nilai($data->id)->k_deskripsi }}</textarea>
                                    </td>
                                    <td class="ctr">
                                    ...
                                    <td class="ctr">
                                        <input type="text" name="nilai" maxlength="2"
                                            ...
                                            class="form-control text-center nilai_{{$data->id}}"
                                            data-ids="{{$data->id}}" autofocus autocomplete="off">
                                        <div class="knilai_{{$data->id}} text-center"></div>
                                    </td>
                                    <td class="ctr">
                                        <input type="text" name="predikat"
                                            class="form-control text-center predikat_{{$data->id}}" disabled>
                                        <div class="kpredikat_{{$data->id}} text-center"></div>
                                    </td>
                                    <td class="ctr">
                                        <textarea
                                            class="form-control swal2-textarea textarea-rapot deskripsi_{{$data->id}}"
