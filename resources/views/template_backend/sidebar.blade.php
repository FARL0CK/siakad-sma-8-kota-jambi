...
<aside class="main-sidebar sidebar-dark-primary elevation-4">
    <!-- Brand Logo -->
    <a href="{{ url('/') }}" class="brand-link" style="">
        <img src="{{ asset('img/favicon.png') }}" alt="AdminLTE Logo" class="brand-image img-circle elevation-3">
        <span class="brand-text font-weight-light">SMA 8 KOTA JAMBI</span>
    </a>
        ...
        <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                ...
                <li class="nav-item has-treeview">
                    ...
                    <ul class="nav nav-treeview ml-4">
                        <li class="nav-item">
                            <a href="{{ route('pengaturan.email') }}" class="nav-link">
                                <i class="fas fa-envelope nav-icon"> </i>
                                <p> Ubah Email</p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="{{ route('pengaturan.password') }}" class="nav-link">
                ...
                <li class="nav-item ">
                    <a href="{{ route('profile') }}" class="nav-link" id="BiodataGuru">
